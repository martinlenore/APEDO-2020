...
df1$DATETIME <- as.POSIXct(df1$DATETIME , format,  tryFormats = c("%H:%M\t%Y-%m-%d","%H:%M\t%Y/%m/%d"))
str(df1)
View(df1)
...
SD1$DATETIME <- as.POSIXct(SD1$DATETIME , format, tryFormats = c("%H:%M\t%Y-%m-%d","%H:%M\t%Y/%m/%d"))
str(SD1)
View(SD1)
...
SD2$DATETIME <- as.POSIXct(SD2$DATETIME , format,  tryFormats = c("%H:%M\t%Y-%m-%d","%H:%M\t%Y/%m/%d"))
str(SD2)
View(SD2)
...
Row7_data$DATETIME <- as.POSIXct(Row7_data$DATETIME,format, tryFormats = c("%H:%M\t%Y-%m-%d","%H:%M\t%Y/%m/%d"))
view(Row7_data)
...
column12_data$DATETIME <- as.POSIXct(column12_data$DATETIME,format, tryFormats = c("%H:%M\t%Y-%m-%d","%H:%M\t%Y/%m/%d"))
view(column12_data)
