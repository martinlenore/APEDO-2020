...
<!--Hearder Div Ends Here -->
  ...
  <%if(user == null){%>
   ...
   <%}else{
	   ...
	   %>
		   <div id="bodyTitle">USER Portal</div>
    <div width="auto" height="335px" align="center" style="margin-top:30px;">
	<table>
	<%for(int i = 0; i < ub.size(); i++){
                  UserBean ubBean = (UserBean) ub.get(i);
					  %>
	<tr>
	  <td style="margin-left:0px;"><%=ubBean.getFirstname()%></td>
	  <td style="margin-left:0px;"><%=ubBean.getLastname()%></td>
	  <td style="margin-left:0px;"><%=ubBean.getEmail()%></td>
	  <td style="margin-left:0px;"><%=ubBean.getContactno()%></td>
	  	  <td style="margin-left:0px;"><%=ubBean.getJobtitle()%></td>
	  <td style="margin-left:0px;"><%=ubBean.getCity()%></td>
	  	  <td style="margin-left:0px;"><%=ubBean.getState()%></td>
	  <td style="margin-left:0px;"><%=ubBean.getLastname()%></td>
