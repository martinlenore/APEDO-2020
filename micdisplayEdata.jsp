...
<!--Hearder Div Ends Here -->
   ...
   String thisLine; 
  int count=0; 
  filename = "/opt/tomcat/apache-tomcat-9.0.37/webapps/amped/micextracteddata/"+filename;
  ...
  int i=0; 
    ...
    <div width="auto" align="center" style="font-family:'Roboto', sans-serif;margin-top:25px;">
